...
net.load_state_dict(torch.load(model_dir, map_location="cuda")["network"])

# 1920x1080 image: tensor shape is NCHW = [batch, channels, height, width]
rgb = torch.randn(1, 3, 1080, 1920).cuda()
...
print("ONNX Export ok: spnet_1080_1920.onnx")
